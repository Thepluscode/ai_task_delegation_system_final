    ...
    <SafeAreaView style={styles.container}>
      <LinearGradient colors={['#f093fb', '#f5576c']} style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerTitle}>Digital Twin Integration</Text>
          <Text style={styles.headerSubtitle}>Virtual commissioning and testing</Text>
        </View>
      </LinearGradient>
      <ScrollView style={styles.content}>
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Digital Twin Status</Text>
          <View style={styles.metricCard}>
            <Text style={styles.metricTitle}>Simulation Accuracy</Text>
            <Text style={styles.metricValue}>99.2%</Text>
          </View>
          <TouchableOpacity style={styles.actionButton} onPress={() => Alert.alert('Digital Twin', 'Simulation started.', [{ text: 'OK' }])}>
            <Text style={styles.actionText}>Start Simulation</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
