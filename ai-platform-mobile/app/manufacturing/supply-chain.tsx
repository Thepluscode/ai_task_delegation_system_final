    ...
    <SafeAreaView style={styles.container}>
      <LinearGradient colors={['#f093fb', '#f5576c']} style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerTitle}>Supply Chain Optimization</Text>
          <Text style={styles.headerSubtitle}>End-to-end visibility and control</Text>
        </View>
      </LinearGradient>
      <ScrollView style={styles.content}>
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.actionButton} onPress={() => Alert.alert('Supply Chain', 'Optimization analysis completed.', [{ text: 'OK' }])}>
            <Text style={styles.actionText}>Optimize Supply Chain</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
