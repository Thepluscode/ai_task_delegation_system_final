...
export default function OEEMonitoringScreen() {
  const handleAction = (action: string) => {
    Alert.alert('OEE Monitoring', `${action} action initiated.`, [{ text: 'OK' }]);
  };
    ...
    <SafeAreaView style={styles.container}>
      <LinearGradient colors={['#f093fb', '#f5576c']} style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerTitle}>OEE Monitoring</Text>
          <Text style={styles.headerSubtitle}>Overall Equipment Effectiveness tracking</Text>
        </View>
      </LinearGradient>
      <ScrollView style={styles.content}>
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>OEE Metrics</Text>
          <View style={styles.metricCard}>
            <Text style={styles.metricTitle}>Overall OEE</Text>
            <Text style={styles.metricValue}>85.2%</Text>
          </View>
          <TouchableOpacity style={styles.actionButton} onPress={() => handleAction('Generate OEE Report')}>
            <Text style={styles.actionText}>Generate OEE Report</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
