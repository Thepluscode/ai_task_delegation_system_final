    ...
    <SafeAreaView style={styles.container}>
      <LinearGradient colors={['#fa709a', '#fee140']} style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerSubtitle}>Customer emotion and intent detection</Text>
        </View>
      </LinearGradient>
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.metricsGrid}>
          ...
          <View style={styles.metricCard}>
            ...
            <Text style={styles.metricLabel}>Reviews Analyzed</Text>
          </View>
          <View style={styles.metricCard}>
            <TrendingUp size={32} color="#8b5cf6" />
            <Text style={styles.metricValue}>+12%</Text>
            <Text style={styles.metricLabel}>Satisfaction Growth</Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
