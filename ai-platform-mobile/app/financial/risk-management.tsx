    ...
    <SafeAreaView style={styles.container}>
      <LinearGradient colors={['#4facfe', '#00f2fe']} style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerTitle}>Risk Management System</Text>
          <Text style={styles.headerSubtitle}>Real-time VaR and stress testing</Text>
        </View>
      </LinearGradient>
      <ScrollView style={styles.content}>
        <View style={styles.section}>
          ...
          <View style={styles.metricCard}>
            <Text style={styles.metricTitle}>Portfolio VaR (95%)</Text>
            <Text style={styles.metricValue}>$1.2M</Text>
          </View>
          <TouchableOpacity style={styles.actionButton} onPress={() => Alert.alert('Risk Management', 'Risk analysis completed.', [{ text: 'OK' }])}>
            <Text style={styles.actionText}>Run Risk Analysis</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
